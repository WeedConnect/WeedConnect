    ...
    <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      ...
      <div className="mt-8 flex flex-col gap-3">
        <p className="rounded-lg border border-amber-200 dark:border-amber-900/40 bg-amber-50/40 dark:bg-amber-950/10 px-4 py-3 text-xs text-foreground/80 leading-relaxed">
          <strong className="text-amber-700 dark:text-amber-400">Aviso:</strong> Contenido informativo. Verifica siempre las fuentes oficiales para temas legales o sanitarios. WeedConnect no es un medio de comunicación y no garantiza la veracidad de las noticias de terceros citadas.
        </p>
